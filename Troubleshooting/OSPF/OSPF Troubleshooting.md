...
3. show run | section router ospf - Verify if all the remote network addresses are advertised.
...
## Modifying Hello timer and MTU size
1. Hello timer
```
interface <interface-id>
ip ospf hello-interval <seconds>   *** <1-65535>  Seconds
```

2. MTU Size
```
interface <interface-id>
ip mtu <size in bytes>    ***<68-1500>  MTU (bytes)
```
